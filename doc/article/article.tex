...
However, the results showed a non-decreasing value of the loss function of 0.9 - better than $-ln(3) \seq 1.1$, which is random guessing, but still not satisfactory.
