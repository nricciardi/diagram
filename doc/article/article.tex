...
As we've seen in the previous section, the need to find the exact position of an arrow's head arises (see \textbf{Appendix~\ref{double_clustering}} for a full overview of the first approaches).

The solution, as stated before, was to 
