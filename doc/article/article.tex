...
Due to the low number of synthetic samples provided, the network is unable to correctly distinguish between an arrow's head and tail. In particular, the network overfitted and simply detected as correct the presence of black ink.
